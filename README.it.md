...
| 🎓 **Apprendimento guidato** | un tour dell'interfaccia in 16 passi al primo avvio che si dimostra da solo — inquadra i tuoi moduli, apre i menu e la palette, sposta un modulo, ingrandisce e scorre il rack, traccia un cavo con i jack compatibili accesi, poi rimette tutto a posto — 30 tutorial passo-passo su 5 livelli, più una guida per argomenti |
