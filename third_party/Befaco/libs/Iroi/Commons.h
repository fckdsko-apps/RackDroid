...
constexpr float kEqualCrossFadeP = 1.8f; //1.4168f;
...
{
    float r;
#if defined(__arm__) && !defined(METAMODULE)
...
inline float MapExpo(float value, float aMin = 0.f, float aMax = 0.97f, float bMin = 0.f, float bMax = 1.f)
{
