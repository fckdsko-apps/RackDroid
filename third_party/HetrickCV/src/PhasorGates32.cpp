...
struct PhasorGates32 : HCVModule
{
...
void PhasorGates32::process(const ProcessArgs &args)
{
...
PhasorGates32Widget::PhasorGates32Widget(PhasorGates32 *module)
{
    setSkinPath("res/PhasorGates32.svg");
