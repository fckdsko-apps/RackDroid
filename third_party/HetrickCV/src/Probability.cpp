...
struct Probability : HCVModule
{
    ...
    dsp::SchmittTrigger clockTrigger[HCV_MAX_POLYPHONY];
    HCVTriggeredGate triggerA[HCV_MAX_POLYPHONY], triggerB[HCV_MAX_POLYPHONY];
    bool outALogic[HCV_MAX_POLYPHONY];
    bool outBLogic[HCV_MAX_POLYPHONY];
    int probMode = 0;
    int outMode = 2;
...
void Probability::process(const ProcessArgs &args)
{
    ...
    outputs[OUTA_OUTPUT].setChannels(polyChannels);
    outputs[OUTB_OUTPUT].setChannels(polyChannels);
