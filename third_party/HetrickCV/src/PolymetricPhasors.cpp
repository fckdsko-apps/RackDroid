...
struct PolymetricPhasors : HCVModule
{
    ...
    HCVPhasorDivMult divMults[3][HCV_MAX_POLYPHONY];
    HCVPhasorResetDetector resetDetectors[3][HCV_MAX_POLYPHONY];
    dsp::SchmittTrigger resetTriggers[3][HCV_MAX_POLYPHONY];
