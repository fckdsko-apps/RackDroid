...
struct Delta : HCVModule
{
    ...
    HCVTriggeredGate ltTrig[HCV_MAX_POLYPHONY], gtTrig[HCV_MAX_POLYPHONY];
    float lastInput[HCV_MAX_POLYPHONY] = {};
    bool rising[HCV_MAX_POLYPHONY] = {};
    bool falling[HCV_MAX_POLYPHONY] = {};
